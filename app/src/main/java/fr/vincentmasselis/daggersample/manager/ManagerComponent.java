...
/**
 * Définie un graphe de données qui englobe toute la gestion des Endpoint et des Manager. Celui ne doit
 * être instancé qu'une fois d'où l'utilisation de l'annotation {@link Singleton}. Il est instancié
 * dans {@link fr.vincentmasselis.daggersample.MyApplication} et reste en mémoire tant que
...
public interface ManagerComponent {
     ...
     * Mais si vous avez plusieurs graphe de données dans votre application, alors il est normal que
     * certains graphe aient besoin d'objets qui sont instancés dans d'autre graph. Pour rendre
     * exploitable par un graphe des objets qui sont définis par un autre graphe il est
